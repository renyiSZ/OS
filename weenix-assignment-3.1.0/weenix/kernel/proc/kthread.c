...
kthread_create(struct proc *p, kthread_func_t func, long arg1, void *arg2)
{
      /* NOT_YET_IMPLEMENTED("PROCS: kthread_create");*/
        ...
        context_setup(&thread_context, func, arg1, arg2, new_thread->kt_kstack, DEFAULT_STACK_SIZE, p->p_pagedir);
        new_thread->kt_ctx = thread_context;

        new_thread->kt_retval = 0;
        new_thread->kt_errno = 0;
        new_thread->kt_cancelled = 0;
        new_thread->kt_wchan = NULL;
        new_thread->kt_state = KT_NO_STATE; // Initial the thread state
