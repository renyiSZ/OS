...
| BUILD & RUN (Required) |
+------------------------+
instructions for building/running this assignment: 
    make clean
    make
    ./weenix -n
...
(B) vfstest: 41 out of 41 pts
    What is your kshell command to invoke vfstest_main(): 
	vfs_test

(C.1) faber_fs_thread_test (3 out of 3 pts)
    What is your kshell command to invoke faber_fs_thread_test(): 
    faber_thr_test 2
    faber_thr_test 3
    faber_thr_test 4
	
(C.2) faber_directory_test (2 out of 2 pts)
    What is your kshell command to invoke faber_directory_test(): 
    faber_dir_test 10
    faber_dir_test 20
    faber_dir_test 30
    faber_dir_test 40
...
1)  Names and USC e-mail addresses of team members: 
	...
	Ziyan Xiong, ziyanxio@usc.edu
	Yi Ren, renyi@usc.edu
	You Wu, youwu@usc.edu
	Zhan Shi, zhans@usc.edu
